...
(function() {
    var provider = app.data.nfcdata = new Everlive({
            offlineStorage: true,
            apiKey: 'TWsQzzbltr7tgUQu',
    ...
    document.addEventListener('online', function() {
        app.data.nfcdata.offline(false);
        app.data.nfcdata.sync();
    });

    document.addEventListener('offline', function() {
        app.data.nfcdata.offline(true);
    });

}());

// START_CUSTOM_CODE_nfcdata
// END_CUSTOM_CODE_nfcdata